...
public class OkHttpUtil {
    ...
    public static String stringMap(String url, Map<String, String> paramsMap, Map<String, String> headerMap) {
        return string(defaultClient(), url, null, paramsMap, headerMap, null);
    }
    ...
    public static Response postResponse(String url, Map<String, String> paramsMap, Map<String, String> headerMap) {
        return new OKRequest(METHOD_POST, url, paramsMap, headerMap, null).executeResponse(defaultClient());
    }

    public static String post(String url, Map<String, String> paramsMap, Map<String, String> headerMap) {
        return string(defaultClient(), METHOD_POST, url, null, paramsMap, headerMap, null);
    }
